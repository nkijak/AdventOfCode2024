defmodule Day11Test do
  ...
  #   {:ok, _} = RuleCache.start()
  #   assert Day11.rules([253,0,2024,14168])
  #     == [512072,1,20,24,28676032]
  # end

  # test "After 4 blinks" do
  #   {:ok, _} = RuleCache.start()
  #   assert Day11.rules([512072,1,20,24,28676032])
  #     == [512,72,2024,2,0,2,4,2867,6032]
  # end

  # test "After 5 blinks" do
  #   {:ok, _} = RuleCache.start()
  #   assert Day11.rules([512,72,2024,2,0,2,4,2867,6032])
  #     == [1036288,7,2,20,24,4048,1,4048,8096,28,67,60,32]
  # end

  # test "After 6 blinks" do
  #   {:ok, _} = RuleCache.start()
  #   assert Day11.rules([1036288,7,2,20,24,4048,1,4048,8096,28,67,60,32])
